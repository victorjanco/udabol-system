...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<div class="card">
		<div class="panel-heading cabecera_frm ">
			<div style="">
				<h2 class="panel-title titulo_frm">IMPORTAR PRECIOS PRODUCTOS EXCEL</h2>
			</div>
			<div><label style="text-align: right; color: white;font-size: 12pt">Precio Costo</label>
			</div>
		</div>
		<form enctype="multipart/form-data" id="frm_import_price_products" method="post">
...
<script>
	$(document).ready(function () {
		...
		$('#frm_import_price_products').on('submit', function (event) {
			event.preventDefault();
			ajaxStart('Importando archivos, espere por favor...');
			$.ajax({
				url: siteurl('product/save_import_price_products_warehouse'),
				method: "POST",
