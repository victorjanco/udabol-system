...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<div class="card">
		<div class="panel-heading cabecera_frm ">
			<div style="">
				<h2 class="panel-title titulo_frm">ELIMINAR STOCK PRODUCTOS EXCEL</h2>
			</div>
			<div><label style="text-align: right; color: white;font-size: 12pt">CANTIDAD</label>
			</div>
		</div>
		<form enctype="multipart/form-data" id="frm_delete_stock_products" method="post">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 ol-xs-12" align="center">
								<button type="submit" class="btn btn-success waves-effect"><i
										class="fa fa-save"></i> Eliminar y Guardar
								</button>
...
<script>
	$(document).ready(function () {
		...
		$('#frm_delete_stock_products').on('submit', function (event) {
			event.preventDefault();
			ajaxStart('Importando archivos, espere por favor...');
			$.ajax({
				url: siteurl('product/delete_import_products_warehouse'),
				method: "POST",
