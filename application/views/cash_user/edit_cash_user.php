    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="panel-heading cabecera_frm ">
                <div>
                    <h2 class="panel-title titulo_frm">Asignacion de Cajas</h2>
                </div>
            </div>
            ...
            <div class="body">
                ...
                method="post">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn-block btn-success waves-effect" id="btn_add_cash_user">
...
<script>
    $(document).ready(function () {
        var option="<button class='btn-danger' onClick='deleteRow(this);'>Eliminar</button>";
