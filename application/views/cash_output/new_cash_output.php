        ...
        <div class="card">
            ...
            <form id="frm_new_cash_output" name="frm_new_cash_output"
                                ...
                                <div class="form-line">
                                    ...
                                    <select class="form-control" id="cash_output_type" name="cash_output_type">
                                        ...
                                        <?php foreach ($cash_output_types as $row) : ?>
                                            <option value="<?= $row->id; ?>" <?= isset($cash_output) ? is_selected($cash_output->tipo_ingreso_caja_id, $row->id) : ''; ?>><?= $row->nombre; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control" id="amount_sus"
                                                name="amount_sus"
                                                placeholder="Ingrese el Monto Sus"
                                                value="0">
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel-footer" align="center">
                    <button id="btn_new_cash_output" class="btn btn-success waves-effect no-modal" type="submit">
