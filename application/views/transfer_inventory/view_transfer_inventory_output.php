    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="panel-heading cabecera_frm">
                <h2 class="panel-title titulo_frm">Datos del Traspaso Salida de Inventario</h2>
            </div>
            <div class="body">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <strong><label for="nro">Nro. Salida Traspaso:</label></strong>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control " name="tipo" id="tipo"
                                       value="<?= $transfer_inventory_output->nombre_tipo_salida ?>" readonly>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h4 align="center">DETALLE DEL TRASPASO DE LA SALIDA DE INVENTARIO</h4>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
