...
$url_action = 'transit/register_transit_approved';
?>
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <form id="frm_transit_approved" name="frm_transit_approved"
                ...
                <div class="modal-footer">
                    <div align="center">
                        ...
                        <a href="<?= site_url('transit/transit_borrowed_piece') ?>" class="btn btn-danger waves-effect" type="submit">
