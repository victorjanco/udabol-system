    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-9 col-md-10 col-sm-8 col-xs-12">
            <div class="form-group">
                <div class="form-line">
                    <textarea class="form-control" id="nombre_actividad" name="nombre_actividad"
...
<div class="modal-footer">
    ...
    <button id="close_modal_registro_actividad" type="button" class="btn btn-danger waves-effect" data-dismiss="modal"><i
