...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>Lista de Ventas Anuladas</h2>
            </div>
            <div class="body">
                        ...
                        <div class="col-lg-4 col-md-3 col-sm-4 col-xs-12">
                            <div class="form-group">
                                <div class="form-line" style="width: 93%; float: left">
                                    ...
                                    <input type="text" class="form-control" name="filter_sale_number"
                                           id="filter_sale_number">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table id="list_sale_note_disable" class="table table-striped table-bordered dataTable ">
                        <thead>
