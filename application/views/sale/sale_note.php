        ...
        <div class="card">
            ...
            <div class="body">
                <div class="card-content">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-4 col-md-3 col-sm-4 col-xs-12">
                            <div class="form-group">
                                <div class="form-line" style="width: 93%; float: left">
                                    <label class="control-label">Nro. de Venta:</label>
                                    <input type="number" class="form-control" name="filter_sale_number"
                                           id="filter_sale_number" placeholder="Nro de venta. ingresar solo numeros">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table id="list_sale_note" class="table table-striped table-bordered dataTable ">
                        <thead>
                        ...
                        <th class="text-center"><b>Monto Bs</b></th>
            ...
            <div class="modal-body">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <div class="form-line">
                                <b>Seleccione una Dosificacion </b>
                                <select id="dosage_id" name="dosage_id" class="form-control">
                                </select>
                            </div>
                        </div>
                    </div>
