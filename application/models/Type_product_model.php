...
class Type_product_model extends CI_Model
{
    ...
    /*Obtener todas los tipo de producto activas especial para cargar combos o autocompletados*/
    public function get_type_product($type = 'object')
    {
        return $this->db->get_where('tipo_producto', array('estado' => get_state_abm('ACTIVO')))->result($type);
    }
