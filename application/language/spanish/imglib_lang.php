...
$lang['imglib_source_image_required'] = "Debes especificar una images en las preferencias.";
$lang['imglib_gd_required'] = "La librería GD es requerida para esta característica.";
$lang['imglib_gd_required_for_props'] = "Su servidor debe soportar la librería GD para poder determinar las propiedades de la images.";
$lang['imglib_unsupported_imagecreate'] = "Su servidor no soporta la función GD que es requerida para este tipo de images.";
...
$lang['imglib_image_process_failed'] = "Procesado de images fallido. Verifique que su servidor soporta la función escogida y que la dirección a la librería de imágenes es correcta.";
$lang['imglib_rotation_angle_required'] = "Se requiere un ángulo de rotación para que la images pueda ser rotada.";
$lang['imglib_writing_failed_gif'] = "Imagen GIF ";
$lang['imglib_invalid_path'] = "La dirección de la images no es correcta.";
$lang['imglib_copy_failed'] = "Falló la rutina de copia de la images.";
$lang['imglib_missing_font'] = "No se ha podido encontrar la fuente que desea usar.";
/* New in 1.6 or Higher  */
$lang['imglib_save_failed'] = "No se puede guardar la images. Por favor, asegúrese que el directorio de imágenes y el archivo se pueden escribir.";
